...
Uint16 SYSTEM_VarGet ( Uint16 nodeid, Uint16 varid, void * value );
Uint16 SYSTEM_VarSet ( Uint16 nodeid, Uint16 varid, void * value );
Uint16 SYSTEM_VarProp ( Uint16 nodeid, Uint16 varid, uint8_t * name, Uint16 * prop );

...
//	SegAddr = FLASH_PR_BASE;
	...
	if( Setup.CSum != CRC16( &Setup, sizeof( Setup ) - sizeof( Setup.CSum ) ))
	{
		...
		Setup.bt_coef = 0.01f;
		Setup.mkbus = 0;
		Setup.time_show = 5000;
		Setup.time_off = 5000;
        
		Setup.id_send[0] = 4201;
		Setup.id_send[1] = 4202;
		Setup.id_send[2] = 4203;
		Setup.id_send[3] = 4204;
		...
		Setup.idunit_send[0] = 200;
		Setup.idunit_send[1] = 200;
		Setup.idunit_send[2] = 200;
		Setup.idunit_send[3] = 200;
